...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 700.
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 500.
...
_HI_STD_TIMEOUT = 5
_HI_STD_FALLBACK_TIME = 1000  # fall back to wheel touch if model is uncertain for a long time
