...
const Rect home_btn = {10, 1080 - 280 - 40, 280, 280};
...
static std::map<UIStatus, Color> bg_colors = {
  {STATUS_OFFROAD, {0x54, 0x54, 0x54}},
  {STATUS_DISENGAGED, {0x3D, 0x3D, 0x3D}},
  {STATUS_ENGAGED, {0x45, 0x00, 0x73}},
  {STATUS_WARNING, {0xDA, 0x6F, 0x25}},
  {STATUS_ALERT, {0x5C, 0x00, 0x39}},
};
