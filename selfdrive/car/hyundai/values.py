...
class SteerLimitParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.SONATA, CAR.PALISADE, CAR.SANTA_FE, CAR.VELOSTER, CAR.KIA_STINGER, CAR.GENESIS_G70, CAR.IONIQ_EV_2020]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
