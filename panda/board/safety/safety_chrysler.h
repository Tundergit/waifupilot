...
const int CHRYSLER_MAX_RT_DELTA = 200;        // max delta torque allowed for real time checks 
const uint32_t CHRYSLER_RT_INTERVAL = 250000;  // 250ms between real time checks
const int CHRYSLER_MAX_RATE_UP = 3;
const int CHRYSLER_MAX_RATE_DOWN = 3;
const int CHRYSLER_MAX_TORQUE_ERROR = 300;    // max torque cmd in excess of torque motor - needs to be higher during override events
